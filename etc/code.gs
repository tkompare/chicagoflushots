...
function addressToPosition() {
	...
	// Set the cell T2 in the first sheet as the current cell.
	// var currentCell = SpreadsheetApp.getActiveSpreadsheet().getSheets()[0].getRange('T2');
	// SpreadsheetApp.setCurrentCell(currentCell);

	// Set range in the first sheet as the active range.
	var activeRange = SpreadsheetApp.getActiveSpreadsheet().getSheets()[0].getRange('T2:V1000');
	SpreadsheetApp.setActiveRange(activeRange);
...
function generateMenu() {
	...
	var entries = [{
		name: "Geocode (Address to Lat, Long)",
